...
struct thread_data{
    ...
    pthread_mutex_t *mutex;         // Mutex info
    int wait_to_release_ms;          // Mutex wait to release in ms
    int wait_to_obtain_ms;          // Mutex wait to obtain in ms
    int error_status;               // Error code of thread.
    /**
